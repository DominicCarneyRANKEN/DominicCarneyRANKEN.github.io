//Create a Command-Line Interface (CLI) appliciation in C# to manage a
//contact list using a Dictionary<string, string>
//The appliciation will allow users to add, retrieve,
//update, and dlete contascts, where the key is the contact's name and the value
//is their phone number

//Main Menu: Display a menu with the following
